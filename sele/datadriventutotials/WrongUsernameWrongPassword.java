...
public class WrongUsernameWrongPassword {
	...
	@Test
	@Parameters({"username","password"}) // xml la irunthu paramter ahhkondu varan so athoda name ahh inga podran
	public void wrongusernameandCorrectPassword (String usenamevalue,String passwordvalue) throws InterruptedException { // para va receive panna receivers ahh eluthikiran
